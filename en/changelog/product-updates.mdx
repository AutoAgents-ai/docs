...
<Update label="August 09 - August 22" tags={["v1.9.0.0"]} rss={{ title: "Agentify v1.9.0.0", description: "Multi-turn conversation logic upgrade, enhanced code block copy functionality, knowledge base parsing capability upgrade, and more new features and optimizations" }}>
  ...
  - Fixed incomplete display of agent external link description information and inability to show complete content on hover, ensuring complete external link information presentation
  - Fixed multi-tenant login logic to resolve issue where multiple matching users with tenant id 1 could not be correctly returned when username doesn't carry tenant code, ensuring normal login functionality
</Update>
